...
urlpatterns = [
    ...
    path("todos/detail/<int:pk>", views.TodoDetailView.as_view(), name="todo-detail"),
    # ''pk since detailview inherited
    path("todos/change/<int:id>", views.TodoEditView.as_view(), name="edit-todo"),
    path('bird/add', views.BirdAddView.as_view(), name="add_bird"),
    path('bird/list', views.BirdListView.as_view(), name="bird_list")
]
